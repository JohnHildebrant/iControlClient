...
@NamedQueries({
    ...
    @NamedQuery(name = "Pool.findByThreshold", query = "SELECT p FROM Pool p "
        + "WHERE p.threshold = :threshold"),
    @NamedQuery(name = "Pool.findByConnections", query = "SELECT p FROM Pool p "
