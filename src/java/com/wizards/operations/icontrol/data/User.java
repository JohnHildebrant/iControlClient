...
@NamedQueries({
    ...
    @NamedQuery(name = "User.findById", query = "SELECT u FROM User u "
        + "WHERE u.id = :id"),
    @NamedQuery(name = "User.findBySamaccountname", query = "SELECT u FROM "
        + "User u WHERE u.samaccountname = :samaccountname"),
    @NamedQuery(name = "User.findByFullname", query = "SELECT u FROM User u "
